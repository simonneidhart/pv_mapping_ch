...
class PlantsMetaCH:
    ...
    def convert_orientation(self):
        ...
        self.metadata["orientation_deg"] = (
            self.metadata["orientation_deg"].map(orientation_mapping).astype(int)
        )
    ...
    def get_single_plant(self, plant_index: int):
